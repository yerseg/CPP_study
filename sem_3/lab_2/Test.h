...
void Test_Dictionary() {
	cout << "«апуск автоматического тестировани€ словар€ (hash-таблицы).....";
	...
	if (Remove)
		cout << "јвтоматическое тестирование пройдено без ошибок" << endl;
}

void Test_BTree() {
	cout << "«апуск тестировани€ B-дерева.....";
...
void Test_Binary_Search() {
	cout << "«апуск тестировани€ бинарного поиска.....";
